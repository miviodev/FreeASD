#ifndef ASD_FONT_BSD_VGAROM_8X16_H
#define ASD_FONT_BSD_VGAROM_8X16_H

#include <stdint.h>

/* Font data: BSD 8x16 VGA ROM font, characters 0x20–0x7E */
static const uint8_t g_bsd_vgarom_8x16[95][16] = {
...
static inline const uint8_t *bsd_vgarom_glyph_8x16(unsigned char ch) {
    if (ch < 0x20 || ch > 0x7E) ch = (unsigned char)'?';
    return g_bsd_vgarom_8x16[ch - 0x20];
}

#endif /* ASD_FONT_BSD_VGAROM_8X16_H */
